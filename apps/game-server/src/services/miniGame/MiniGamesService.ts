...
export default class MiniGamesService {
    ...
    static async runGame1(userId: string) {
        ...
        await ProfileService.chargeEnergy(userId, MINI_GAMES_INFO["miniGame1"].energy);
    ...
    /**
     * Handles operations for Mini Game 2 (Higher/Lower number guessing)
     */
    static async handleGame2(
        ...
        try {
            if (operation === MINIGAME_OPERATION_START) {
                ...
                await ProfileService.chargeEnergy(userId, MINI_GAMES_INFO["miniGame2"].energy);
                ...
                const median =
                    (miniGame2RemainingNumbers[0] +
                        miniGame2RemainingNumbers[miniGame2RemainingNumbers.length - 1]) /
                    2;
                ...
                if (userCorrectGuesses === 1) {
                    await ProfileService.addLootBox(userId, MiniGamesLootBoxEnum.COMMON);
                } else if (userCorrectGuesses === 2) {
                    await ProfileService.addLootBox(userId, MiniGamesLootBoxEnum.UNCOMMON);
                } else if (userCorrectGuesses >= 3 && userCorrectGuesses <= 4) {
                    await ProfileService.addLootBox(userId, MiniGamesLootBoxEnum.RARE);
                } else if (userCorrectGuesses === 5) {
                    await ProfileService.addLootBox(userId, MiniGamesLootBoxEnum.EPIC);
                } else if (userCorrectGuesses === 6) {
                    await ProfileService.addLootBox(userId, MiniGamesLootBoxEnum.LEGENDARY);
                }
    ...
    /**
     * Handles operations for Mini Game 3 (Pick the Boxes)
     */
    static async handleGame3(
        ...
        try {
            if (operation === MINIGAME_OPERATION_START) {
                ...
                await ProfileService.chargeEnergy(userId, MINI_GAMES_INFO["miniGame3"].energy);
                ...
                if (fetchedMiniGamesProfile.miniGame3.user_correct_guesses >= 5) {
                    throw ERRORS.VALIDATION("Mini Game 3 already solved");
                }

                const phase =
                    (fetchedMiniGamesProfile.miniGame3.user_correct_guesses || 0) + 1;
                ...
                return {
                    status: userLost ? MINIGAME_STATUS_LOST : MINIGAME_STATUS_SUCCESS,
                    userCorrectGuesses: fetchedMiniGamesProfile.miniGame3.user_correct_guesses,
                    nullBoxIndexes,
                };
            } else if (operation === MINIGAME_OPERATION_END) {
                const fetchedMiniGamesProfile =
    ...
    /**
     * Handles operations for Mini Game 4 (Rock Paper Scissors)
     */
    static async handleGame4(
        ...
        try {
            if (operation === MINIGAME_OPERATION_START) {
                ...
                await ProfileService.chargeEnergy(userId, MINI_GAMES_INFO["miniGame4"].energy);
                ...
                if (computerMove === "rock") {
                    if (userGuess === "rock")
                        fetchedMiniGamesProfile.miniGame4.user_correct_guesses += MINIGAME_4_DRAW_POINTS;
                    else if (userGuess === "paper")
                        fetchedMiniGamesProfile.miniGame4.user_correct_guesses += MINIGAME_4_WIN_POINTS;
                    else userLost = true;
                ...
                return {
                    status: userLost ? MINIGAME_STATUS_LOST : MINIGAME_STATUS_SUCCESS,
                    userCorrectGuesses: fetchedMiniGamesProfile.miniGame4.user_correct_guesses,
                    computerMove,
                };
            } else if (operation === MINIGAME_OPERATION_END) {
                const fetchedMiniGamesProfile =
