...
export type BillingTransactionType = InferSchemaType<
    typeof BillingTransactionSchema
>;

const BillingTransactionModel = billingDBConn.model<BillingTransactionType>(
    "BillingTransaction",
